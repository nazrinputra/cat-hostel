              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="/8ag1/staffs_edit.php?user_id=<?php echo $row["user_id"] ?>">
                        <button type="button" class="btn btn-primary btn-sm">
                      ...
                      ?>
                        <a href="/8ag1/staffs_deactivate.php?user_id=<?php echo $row["user_id"] ?>">
                      ...
                      ?>
                        <a href="/8ag1/staffs_activate.php?user_id=<?php echo $row["user_id"] ?>">
