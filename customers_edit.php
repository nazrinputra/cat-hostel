...
if (isset($_POST['update-button'])) {
  ...
  $row  = mysqli_fetch_array($result);
  if (is_array($row)) {
    echo '<script>alert("Email already exist!");window.location.href="/8ag1/customers_edit.php?user_id=' . $user_id . '";</script>';
  } else {
    ...
    echo '<script>alert("Customer has been updated.");window.location.href="/8ag1/customers.php";</script>';
  }
}
?>
