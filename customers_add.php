...
if (isset($_POST['save-button'])) {
  ...
  if (is_array($row)) {
    ...
    $sql = "INSERT into `user` (user_name, user_password, user_email, user_ic, user_contact, user_gender, user_role, user_active) VALUES ('{$user_name_register}', '{$user_password_register}', '{$user_email_register}', '{$user_ic_register}', '{$user_contact_register}', '{$user_gender_register}', 'Customer', true)";
